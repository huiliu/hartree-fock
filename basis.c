...
// ----------------------------------------------------------------------------
// read basis functinon information include the exponent and coefficient
#define Item_count              3
...
BASIS* readbasis(FILE * f, int basisCount, unsigned short *gtoCount)
{
